...
@njit
def mb_forget_diffa_session_value(choices, second_steps, outcomes, n_trials, transition_type, params):
  # Unpack parameters.
...
def mb_forget_diffa_session_simulate(n_trials, task, param_names, params, kernels):
  # Unpack parameters.
  alpha_pos, alpha_neg, weight_mb, forget = params[:4]
...
class MB_forget_diffa(RL_agent):
  ...
  def session_simulate(self, task, params, n_trials):
    return mb_forget_diffa_session_simulate(n_trials, task, self.param_names, params, self.use_kernels)
